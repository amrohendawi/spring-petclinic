...
class ClinicServiceTests {
	...
	// Added tests to kill mutations related to getPet(String) and getPet(int) behavior
	@Test
	void shouldReturnNullWhenPetNotFound() {
		...
		// Testing getPet(String) with a non-existing pet name
		assertThat(owner.getPet("nonExistingPetName")).isNull();

		// Testing getPet(int) with an invalid pet id
