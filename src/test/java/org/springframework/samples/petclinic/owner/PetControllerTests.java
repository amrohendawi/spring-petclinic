 ...
 *
 * This class contains tests for the PetController and also includes a test for the
 * toString method of NamedEntity.
 *
...
class PetControllerTests {
	...
	void testOwnerToString() {
		...
		String expectedString = "Owner{id=1, firstName='John', lastName='Doe', address='123 Street', city='City', telephone='1234567890'}";
