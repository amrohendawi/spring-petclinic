...
class OwnerControllerTests {
	...
	void setup() {
		...
		// Ensure getPet returns a non-null pet before adding a visit
		assertNotNull(george.getPet("Max"), "Expected to find pet 'Max' in setup");
	...
	void testShowOwner() throws Exception {
		...
		// Additional assertions to ensure that the getPet method works correctly,
		// killing the negated conditional mutation in Owner.getPet.
		Owner owner = (Owner) result.getModelAndView().getModel().get("owner");
		assertNotNull(owner.getPet("Max"), "Expected to retrieve pet 'Max'");
		assertNull(owner.getPet("Nonexistent"), "Expected to not retrieve a pet for a name that does not exist");
	}
