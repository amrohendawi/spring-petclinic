...
class OwnerControllerTests {
	...
	void setup() {
		...
		// This call will exercise the getPet method
		Pet pet = george.getPet("Max");
		// Ensure that getPet("Max") returns the correct pet
		assertNotNull(pet, "Expected pet named 'Max' to be found");
		assertEquals("Max", pet.getName(), "Expected pet name to be 'Max'");
	...
	void testShowOwner() throws Exception {
		mockMvc.perform(get("/owners/{ownerId}", TEST_OWNER_ID))
			...
			// Additional assertion to verify that getPet("Max") returns the correct pet
			.andExpect(mvcResult -> {
				Owner owner = (Owner) mvcResult.getModelAndView().getModel().get("owner");
				Pet pet = owner.getPet("Max");
				assertNotNull(pet, "Expected getPet(\"Max\") to return a non-null pet");
				assertEquals("Max", pet.getName(), "Expected the pet name to be 'Max'");
			})
