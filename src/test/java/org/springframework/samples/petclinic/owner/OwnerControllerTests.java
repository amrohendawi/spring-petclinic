...
class OwnerControllerTests {
	...
	void testShowOwner() throws Exception {
		...
		// Additional assertions to cover negative scenarios for Owner.getPet method
		Owner owner = (Owner) result.getModelAndView().getModel().get("owner");
		// When a pet name that does not exist is provided, getPet should return null
		assertNull(owner.getPet("NonExisting"), "Expected getPet to return null for non-existing pet name.");
		// Check case sensitivity: 'max' in lower case should return null if getPet is
		// case sensitive
		assertNull(owner.getPet("max"), "Expected getPet to return null for case mismatched pet name.");
	}
