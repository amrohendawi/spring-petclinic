...
import static org.junit.jupiter.api.Assertions.assertNull; // added import
...
class OwnerControllerTests {
	...
	void testShowOwner() throws Exception {
		...
		// Additional assertions to exercise Owner#getPet
		Owner testOwner = george();
		assertNotNull(testOwner.getPet("Max"), "Expected to find pet 'Max'");
		assertNull(testOwner.getPet("Buddy"), "Expected no pet with name 'Buddy'");
	}
