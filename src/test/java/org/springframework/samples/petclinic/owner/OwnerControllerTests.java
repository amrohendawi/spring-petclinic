...
class OwnerControllerTests {
	...
	// Additional tests added to directly validate Owner.getPet behavior to kill the
	// mutation
	@Test
	void testGetExistingPet() {
		Owner owner = george();
		Pet pet = owner.getPet("Max");
		assertNotNull(pet, "Expected to find pet named 'Max'");
		assertEquals("Max", pet.getName(), "The returned pet should have the name 'Max'");
	}
	...
	void testGetNonExistingPet() {
		...
		assertNull(pet, "Expected null when no pet matches the given name");
	}
