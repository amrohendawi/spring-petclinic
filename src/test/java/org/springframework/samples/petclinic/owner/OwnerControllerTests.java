 ...
 *
 * Additional assertions have been added to test negative and edge cases for the getPet
 * method in Owner to ensure that mutations affecting pet lookup logic are caught.
 *
 * @author Colin But
 * @author Wick Dynex
 */
...
class OwnerControllerTests {
	...
	void testShowOwner() throws Exception {
		mockMvc.perform(get("/owners/{ownerId}", TEST_OWNER_ID))
			...
			// Additional assertion to verify getPet behavior for non-existent pet names
			.andExpect(result -> {
				Owner owner = (Owner) result.getModelAndView().getModel().get("owner");
				// When a pet with a non-existent name is requested, it should return null
