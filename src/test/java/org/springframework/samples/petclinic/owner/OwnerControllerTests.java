 ...
 *
 * (Modified to add assertions for Owner.getPet behavior to catch surviving mutation
 * errors.)
 *
 * @author Colin But
 * @author Wick Dynex
...
class OwnerControllerTests {
	...
	void setup() {
		...
		Owner george = george();
		// Verify that getPet method returns the correct pet to catch mutation errors
		Pet retrievedPet = george.getPet("Max");
		assertNotNull(retrievedPet, "Expected pet 'Max' to be found");
		assertEquals("Max", retrievedPet.getName(), "getPet should return the pet with the exact name 'Max'");
		...
		retrievedPet.getVisits().add(visit);
	}
