...
class OwnerControllerTests {
    ...
    @Test
    void testGetPetWithDifferentNames() throws Exception {
        Owner george = george();
        given(this.owners.findById(TEST_OWNER_ID)).willReturn(Optional.of(george));

        // Confirming existing pet is retrieved
        assertNotNull(george.getPet("Max"));
        
        // Confirming non-existing pet returns null
        assertNull(george.getPet("Bella"));
    }
}
