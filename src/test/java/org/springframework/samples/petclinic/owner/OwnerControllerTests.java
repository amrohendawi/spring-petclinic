	...
	void testShowOwner() throws Exception {
		mockMvc.perform(get("/owners/{ownerId}", TEST_OWNER_ID))
			...
			.andExpect(result -> {
				...
				// Explicit assertions to verify the behavior of getPet method
				assertNotNull(owner.getPet("Max"), "Expected pet 'Max' to be present");
				assertNull(owner.getPet("Garfield"), "Expected getPet to return null for non-existing pet 'Garfield'");
			});
	}
