...
public class PostgresIntegrationTests {
	...
	void testNamedEntityToString() {
		// Direct unit test for NamedEntity.toString to ensure its output meets the
		// expected format
		// Create an instance of NamedEntity using an anonymous subclass (in case
		// NamedEntity is abstract)
		NamedEntity entity = new NamedEntity() {
		};
		entity.setName("Buddy");
		String result = entity.toString();
		// Expecting that toString returns exactly the name that was set
		assertThat(result).isEqualTo("Buddy");
	}
