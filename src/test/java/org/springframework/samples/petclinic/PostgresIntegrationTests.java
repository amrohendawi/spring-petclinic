...
public class PostgresIntegrationTests {
	...
	void testOwnerDetails() {
		...
		// Added assertions to verify the correctness of Owner.toString() output
		Owner owner = new Owner();
		owner.setId(1);
		owner.setFirstName("George");
		owner.setLastName("Franklin");
		// Optionally, additional fields can be set if available
		String ownerString = owner.toString();
		assertThat(ownerString).isNotEmpty().contains("1").contains("George").contains("Franklin");
	}
