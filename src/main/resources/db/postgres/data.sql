...
INSERT INTO pets (name, birth_date, type_id, owner_id, is_new_pet, photo_file_name) SELECT 'Leo', '2000-09-07', 1, 1, FALSE, NULL WHERE NOT EXISTS (SELECT * FROM pets WHERE id=1);
INSERT INTO pets (name, birth_date, type_id, owner_id, is_new_pet, photo_file_name) SELECT 'Basil', '2002-08-06', 6, 2, FALSE, NULL WHERE NOT EXISTS (SELECT * FROM pets WHERE id=2);
INSERT INTO pets (name, birth_date, type_id, owner_id, is_new_pet, photo_file_name) SELECT 'Rosy', '2001-04-17', 2, 3, FALSE, NULL WHERE NOT EXISTS (SELECT * FROM pets WHERE id=3);
INSERT INTO pets (name, birth_date, type_id, owner_id, is_new_pet, photo_file_name) SELECT 'Jewel', '2000-03-07', 2, 3, FALSE, NULL WHERE NOT EXISTS (SELECT * FROM pets WHERE id=4);
INSERT INTO pets (name, birth_date, type_id, owner_id, is_new_pet, photo_file_name) SELECT 'Iggy', '2000-11-30', 3, 4, FALSE, NULL WHERE NOT EXISTS (SELECT * FROM pets WHERE id=5);
INSERT INTO pets (name, birth_date, type_id, owner_id, is_new_pet, photo_file_name) SELECT 'George', '2000-01-20', 4, 5, FALSE, NULL WHERE NOT EXISTS (SELECT * FROM pets WHERE id=6);
INSERT INTO pets (name, birth_date, type_id, owner_id, is_new_pet, photo_file_name) SELECT 'Samantha', '1995-09-04', 1, 6, FALSE, NULL WHERE NOT EXISTS (SELECT * FROM pets WHERE id=7);
INSERT INTO pets (name, birth_date, type_id, owner_id, is_new_pet, photo_file_name) SELECT 'Max', '1995-09-04', 1, 6, FALSE, NULL WHERE NOT EXISTS (SELECT * FROM pets WHERE id=8);
INSERT INTO pets (name, birth_date, type_id, owner_id, is_new_pet, photo_file_name) SELECT 'Lucky', '1999-08-06', 5, 7, FALSE, NULL WHERE NOT EXISTS (SELECT * FROM pets WHERE id=9);
INSERT INTO pets (name, birth_date, type_id, owner_id, is_new_pet, photo_file_name) SELECT 'Mulligan', '1997-02-24', 2, 8, FALSE, NULL WHERE NOT EXISTS (SELECT * FROM pets WHERE id=10);
INSERT INTO pets (name, birth_date, type_id, owner_id, is_new_pet, photo_file_name) SELECT 'Freddy', '2000-03-09', 5, 9, FALSE, NULL WHERE NOT EXISTS (SELECT * FROM pets WHERE id=11);
INSERT INTO pets (name, birth_date, type_id, owner_id, is_new_pet, photo_file_name) SELECT 'Lucky', '2000-06-24', 2, 10, FALSE, NULL WHERE NOT EXISTS (SELECT * FROM pets WHERE id=12);
INSERT INTO pets (name, birth_date, type_id, owner_id, is_new_pet, photo_file_name) SELECT 'Sly', '2002-06-08', 1, 10, FALSE, NULL WHERE NOT EXISTS (SELECT * FROM pets WHERE id=13);
